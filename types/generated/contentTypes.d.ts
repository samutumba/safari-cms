...
export interface ApiLocationLocation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    accommodations: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.RichText;
    price: Attribute.String;
    currency: Attribute.Enumeration<['UGX', 'USD', 'CAD', 'TZS', 'KES', 'RWF']>;
...
export interface ApiTourTour extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lengthOfTime: Attribute.String;
    slug: Attribute.UID;
    pricePerUnit: Attribute.Decimal;
    currency: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'UGX'>;
    numberOfPeoplePerUnit: Attribute.Integer;
